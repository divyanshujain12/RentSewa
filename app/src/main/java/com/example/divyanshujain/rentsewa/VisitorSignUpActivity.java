...
public class VisitorSignUpActivity extends BaseActivity {
    ...
    private void initViews() {
        ...
        emailET.setText(getIntent().getStringExtra(Constants.EMAIl));
        usernameET.setText(getIntent().getStringExtra(Constants.NAME));
    ...
    private void hitWebService() {
        ...
        if (formValues != null) {
            ...
            CallWebService.getInstance(this, true, ApiCodes.REGISTRATION).hitJsonObjectRequestAPI(CallWebService.POST, API.REGISTRATION_FB_VISITOR, createJsonForSignUp(), this);
        }
    }
    ...
    private JSONObject createJsonForSignUp() {
        ...
        try {
            ...
            jsonObject.put(Constants.FB_ID, getIntent().getStringExtra(Constants.FB_ID));
